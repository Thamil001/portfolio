import { ReactLogo, JsLogo, openSource,JavaLogo, css,Spring, MySql, Ts, TailwindCss, Git,p1,p2,p3,p4, vscode, gmail, linkedIn, gitHub, resume ,resumedDoc, logoAnimation} from "../assets/images"
export const ProjectData = [{
    ...
    "projectTitle": "MemoDraft", "techStacks": [ReactLogo,css,JsLogo,Spring,Git], "projectLogo": p4, "description":
        "Simple public note-sharing platform for creating and managing short notes.Clean responsive interface with fast note posting and real-time updates.","url":"https://github.com/Thamil001/memodraft"
}]
